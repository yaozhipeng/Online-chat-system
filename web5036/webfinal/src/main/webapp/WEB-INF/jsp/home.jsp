<%@ page import="cn.edu.ncu.cs15.dto.HomeExecution" %>
<%@ page import="cn.edu.ncu.cs15.dto.Result" %>
<%@ page import="cn.edu.ncu.cs15.dto.Friend" %>
<%@ page import="java.util.List" %>
<%@ page import="cn.edu.ncu.cs15.entity.Information" %>
<%@ page import="java.util.Map" %>
<%@ page import="cn.edu.ncu.cs15.entity.Impression" %>
                ...
                <%
                    for(Friend f : friendList) {
                        ...
                        String content = "邮箱: " + f.getEmail() +
                                "<br>性别: " + gender +
                                "<br>个性签名: " + information.getMotto() +
                                "<br>学校: " + information.getSchool() +
